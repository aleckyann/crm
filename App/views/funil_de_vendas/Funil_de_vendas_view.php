    ...
    <div class="breadcrumb-bar navbar bg-white sticky-top">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Funis de venda</li>
            </ol>
        </nav>
        <div class="dropdown">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-11 col-xl-10">
                <div class="page-header">
                    ...
                    <p class="lead">Aqui estão agrupados os funis de vendas por localidade atendida</p>
                </div>
                        ...
                        <div class="content-list-body row">
                            ...
                            <div class="col-md-6">
                                <div class="card card-team">
                                    <div class="card-body">
                                        <a href="<?=base_url('funil-de-vendas/'.$l['localidade_id']) ?>" class="btn btn-secondary float-right">Acessar</a>
