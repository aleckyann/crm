...
<head>
  ...
  <link rel="stylesheet" href="<?=base_url() ?>public/assets/vendor/font-awesome/css/fontawesome-all.min.css">
  <link rel="stylesheet" href="<?=base_url() ?>public/assets/vendor/animate.css/animate.min.css">
  <link rel="stylesheet" href="<?=base_url() ?>public/assets/vendor/slick-carousel/slick/slick.css">
...
<body>
      ...
      <div class="col-lg-5 col-xl-4 d-none d-lg-flex align-items-center gradient-half-primary-v1 height-lg-100vh px-0">
        <div class="w-100 p-5">
          ...
          <div id="testimonialsNavPagination" class="js-slick-carousel u-slick u-slick--transform-off u-slick--pagination-modern u-slick--transform-off mx-auto"
            ...
            <div class="js-slide">
              <div class="u-avatar mx-auto">
                <img class="img-fluid rounded-circle" src="<?=base_url() ?>public/assets/img/100x100/img1.jpg" alt="Image Description">
              </div>
            </div>

            <div class="js-slide">
              <div class="u-avatar mx-auto">
                <img class="img-fluid rounded-circle" src="<?=base_url() ?>public/assets/img/100x100/img3.jpg" alt="Image Description">
              </div>
            </div>

            <div class="js-slide">
              <div class="u-avatar mx-auto">
                <img class="img-fluid rounded-circle" src="<?=base_url() ?>public/assets/img/100x100/img2.jpg" alt="Image Description">
              </div>
            </div>
          </div>
          ...
          <div class="position-absolute right-0 bottom-0 left-0 text-center p-5">
            <h4 class="h6 text-white-70 mb-3">Parceiros</h4>
            <div class="d-flex justify-content-center">
              <div class="mx-4">
                <img class="u-clients" src="<?=base_url() ?>public/assets/svg/clients-logo/slack-white.svg" alt="Image Description">
              </div>
              <div class="mx-4">
                <img class="u-clients" src="<?=base_url() ?>public/assets/svg/clients-logo/google-white.svg" alt="Image Description">
              </div>
              <div class="mx-4">
                <img class="u-clients" src="<?=base_url() ?>public/assets/svg/clients-logo/spotify-white.svg" alt="Image Description">
              </div>
            </div>
          </div>
          <!-- End Clients -->
      ...
      <div class="container">
        <div class="row no-gutters">
          <div class="col-md-8 col-lg-7 col-xl-6 offset-md-2 offset-lg-2 offset-xl-3 space-3 space-lg-0">
            ...
            <!-- Form -->
            <form class="js-validate mt-5" action="<?=base_url('registrar') ?>" method="post">
              <?=$csrf_input ?>
              <!-- Title -->
              <div class="mb-7">
                <h1 class="h3 text-primary font-weight-normal mb-0">Bem vindo ao <span class="font-weight-semi-bold">Vutu</span></h1>
                <p>Cadastre-se e comece agora mesmo!</p>
              </div>
              <!-- End Title -->
              ...
              <div class="js-form-message form-group">
                ...
                <input type="email" class="form-control" name="email" id="signinSrEmail" placeholder="Email address" aria-label="Email address" required
                       data-msg="Este e-mail parece ser inválido."
              ...
              <!-- Form Group -->
              <div class="js-form-message form-group">
                <label class="form-label" for="signinSrPassword">Senha</label>
                <input type="password" class="form-control" name="senha" id="signinSrPassword" placeholder="********" aria-label="********" required
                       data-msg="Sua senha está incorreta, tente novamente"
                       data-error-class="u-has-error"
                       data-success-class="u-has-success">
              </div>
              <!-- End Form Group -->
              ...
              <!-- Form Group -->
              <div class="js-form-message form-group">
                <label class="form-label" for="signinSrConfirmPassword">Confirme sua senha</label>
                <input type="password" class="form-control" name="senha" id="signinSrConfirmPassword" placeholder="********" aria-label="********" required
                       data-msg="As senhas não são iguais, confira e preencha novamente."
                       data-error-class="u-has-error"
                       data-success-class="u-has-success">
              </div>
              <!-- End Form Group -->
              ...
              <div class="js-form-message mb-5">
                <div class="custom-control custom-checkbox d-flex align-items-center text-muted">
                  <input type="checkbox" class="custom-control-input" id="termsCheckbox" name="termos" required
                         data-msg="Você precisa aceitar os nossos termos e condições."
                         data-error-class="u-has-error"
                         data-success-class="u-has-success">
                  <label class="custom-control-label" for="termsCheckbox">
                    <small>
                      Eu aceito os
                      <a class="link-muted" href="<?=base_url()?>">Termos e condições</a>
                    </small>
                  </label>
                </div>
              </div>
              ...
              <div class="row align-items-center mb-5">
                <div class="col-5 col-sm-6">
                  <span class="small text-muted">Você já tem um conta?</span>
                  <a class="small" href="<?=base_url('autenticar') ?>">Autenticar</a>
                </div>

                <div class="col-7 col-sm-6 text-right">
                  <button type="submit" class="btn btn-primary transition-3d-hover">Começar  . . .</button>
                </div>
              </div>
              <!-- End Button -->
            </form>
  ...
  <script src="<?=base_url() ?>public/assets/vendor/jquery-migrate/dist/jquery-migrate.min.js"></script>
  <script src="<?=base_url() ?>public/assets/vendor/popper.js/dist/umd/popper.min.js"></script>
  <script src="<?=base_url() ?>public/assets/vendor/bootstrap/bootstrap.min.js"></script>

  <!-- JS Implementing Plugins -->
  <script src="<?=base_url() ?>public/assets/vendor/jquery-validation/dist/jquery.validate.min.js"></script>
  <script src="<?=base_url() ?>public/assets/vendor/slick-carousel/slick/slick.js"></script>

  <!-- JS Front -->
  <script src="<?=base_url() ?>public/assets/js/hs.core.js"></script>
  <script src="<?=base_url() ?>public/assets/js/components/hs.validation.js"></script>
  <script src="<?=base_url() ?>public/assets/js/components/hs.slick-carousel.js"></script>
